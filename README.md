...
```bash
git clone https://github.com/LuanMSouza/eg-personalizados-front
cd eg-personalizados-front
npm install
npm run dev
```
...
|---|---|
| [eg-personalizados-gestao-front](https://github.com/LuanMSouza/eg-personalizados-gestao-front) | Dashboard de gestão |
